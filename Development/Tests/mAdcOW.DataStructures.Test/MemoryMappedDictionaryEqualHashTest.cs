...
namespace mAdcOW.DataStructures.Test
{
    ...
    {
        private static mAdcOW.DataStructures.Dictionary<Customer, int> _dict;
        private static mAdcOW.DataStructures.Dictionary<Customer, Customer> _dict2;

        [TestInitialize()]
        public void InitializeDictionary()
        {
            string path = AppDomain.CurrentDomain.BaseDirectory;
            _dict = new mAdcOW.DataStructures.Dictionary<Customer, int>(path);
