...
{
    /// <summary>
    ///This is a test class for MemoryMappedList and is intended
    ///to contain all MemoryMappedList Unit Tests
    ///</summary>
    [TestClass]
    public class MemoryMappedList
    {
        private MemoryMappedList<int> _testList;
        ...
        public void MyTestInitialize()
        {
            ...
            _testList = new MemoryMappedList<int>(1024*1024, path);
        }
